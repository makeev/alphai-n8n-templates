...
Title: **Send daily AI market briefings to email and Discord using AlphAI and GPT**
...
An AlphAI account (the free tier covers up to 6 tickers per briefing), an OpenAI (or other LLM) key, and an SMTP mailbox.
